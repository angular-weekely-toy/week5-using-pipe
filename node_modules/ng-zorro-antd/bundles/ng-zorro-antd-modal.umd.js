(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var BaseModalContainerComponent = /** @class */ (function (_super) {
        ...
        function BaseModalContainerComponent(ngZone, elementRef, focusTrapFactory, cdr, render, overlayRef, nzConfigService, config, document, animationType) {
        ...
        BaseModalContainerComponent.prototype.savePreviouslyFocusedElement = function () {
            ...
            if (this.document) {
                ...
                if (this.elementRef.nativeElement.focus) {
                    this.ngZone.runOutsideAngular(function () { return Promise.resolve().then(function () { return _this.elementRef.nativeElement.focus(); }); });
                }
            }
        };
    ...
    var NzModalConfirmContainerComponent = /** @class */ (function (_super) {
        ...
        function NzModalConfirmContainerComponent(ngZone, i18n, elementRef, focusTrapFactory, cdr, render, overlayRef, nzConfigService, config, document, animationType) {
            var _this = _super.call(this, ngZone, elementRef, focusTrapFactory, cdr, render, overlayRef, nzConfigService, config, document, animationType) || this;
            _this.i18n = i18n;
            _this.config = config;
            _this.cancelTriggered = new core.EventEmitter();
            _this.okTriggered = new core.EventEmitter();
    ...
    var NzModalContainerComponent = /** @class */ (function (_super) {
        ...
        function NzModalContainerComponent(ngZone, elementRef, focusTrapFactory, cdr, render, overlayRef, nzConfigService, config, document, animationType) {
            var _this = _super.call(this, ngZone, elementRef, focusTrapFactory, cdr, render, overlayRef, nzConfigService, config, document, animationType) || this;
            _this.config = config;
            return _this;
        }
        ...
        NzModalFooterComponent.prototype.onButtonClick = function (options) {
            ...
            if (!loading) {
                ...
                if (options.autoLoading && util.isPromise(result)) {
                    ...
                    result
                        .then(function () { return (options.loading = false); })
                        .catch(function (e) {
