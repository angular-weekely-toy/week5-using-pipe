    ...
    ***************************************************************************** */
    ...
    var NzTooltipBaseDirective = /** @class */ (function () {
        ...
        NzTooltipBaseDirective.prototype.registerTriggers = function () {
            ...
            if (trigger === 'hover') {
                ...
                this.triggerDisposables.push(this.renderer.listen(el, 'focusin', function () { return _this.show(); }));
                this.triggerDisposables.push(this.renderer.listen(el, 'focusout', function () { return _this.hide(); }));
            }
        ...
        NzTooltipBaseDirective.prototype.updatePropertiesByKeys = function (keys) {
            ...
            var mappingProperties = Object.assign({
                // common mappings
                title: ['nzTitle', function () { return _this._title; }], directiveTitle: ['nzTitle', function () { return _this._title; }], content: ['nzContent', function () { return _this._content; }], directiveContent: ['nzContent', function () { return _this._content; }], trigger: ['nzTrigger', function () { return _this._trigger; }], placement: ['nzPlacement', function () { return _this._placement; }], visible: ['nzVisible', function () { return _this._visible; }], mouseEnterDelay: ['nzMouseEnterDelay', function () { return _this._mouseEnterDelay; }], mouseLeaveDelay: ['nzMouseLeaveDelay', function () { return _this._mouseLeaveDelay; }], overlayClassName: ['nzOverlayClassName', function () { return _this._overlayClassName; }], overlayStyle: ['nzOverlayStyle', function () { return _this._overlayStyle; }], arrowPointAtCenter: ['nzArrowPointAtCenter', function () { return _this.arrowPointAtCenter; }]
    ...
    var NzTooltipDirective = /** @class */ (function (_super) {
        ...
        NzTooltipDirective.prototype.getProxyPropertyMap = function () {
            var _this = this;
            return Object.assign(Object.assign({}, _super.prototype.getProxyPropertyMap.call(this)), { nzTooltipColor: ['nzColor', function () { return _this.nzTooltipColor; }], nzTooltipTitleContext: ['nzTitleContext', function () { return _this.titleContext; }] });
        };
    ...
    NzTooltipDirective.propDecorators = {
        ...
        titleContext: [{ type: core.Input, args: ['nzTooltipTitleContext',] }],
        ...
        arrowPointAtCenter: [{ type: core.Input, args: ['nzTooltipArrowPointAtCenter',] }],
