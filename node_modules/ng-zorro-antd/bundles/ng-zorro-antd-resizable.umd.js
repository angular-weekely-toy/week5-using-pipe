(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/cdk/platform'), require('rxjs'), require('rxjs/operators'), require('ng-zorro-antd/core/util')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/resizable', ['exports', '@angular/common', '@angular/core', '@angular/cdk/platform', 'rxjs', 'rxjs/operators', 'ng-zorro-antd/core/util'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["ng-zorro-antd"] = global["ng-zorro-antd"] || {}, global["ng-zorro-antd"].resizable = {}), global.ng.common, global.ng.core, global.ng.cdk.platform, global.rxjs, global.rxjs.operators, global["ng-zorro-antd"].core.util));
})(this, (function (exports, common, core, platform, rxjs, operators, util) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NzResizableDirective = /** @class */ (function () {
        ...
        NzResizableDirective.prototype.ngAfterViewInit = function () {
            ...
            this.setPosition();
            this.ngZone.runOutsideAngular(function () {
                rxjs.fromEvent(_this.el, 'mouseenter')
                    .pipe(operators.takeUntil(_this.destroy$))
                    .subscribe(function () {
                    _this.nzResizableService.mouseEntered$.next(true);
                });
                rxjs.fromEvent(_this.el, 'mouseleave')
                    .pipe(operators.takeUntil(_this.destroy$))
                    .subscribe(function () {
                    _this.nzResizableService.mouseEntered$.next(false);
                });
            });
        };
    ...
    var NzResizeHandleComponent = /** @class */ (function () {
        function NzResizeHandleComponent(nzResizableService, renderer, elementRef) {
            this.nzResizableService = nzResizableService;
            this.renderer = renderer;
            this.elementRef = elementRef;
        ...
        NzResizeHandleComponent.prototype.ngOnInit = function () {
            ...
            this.nzResizableService.mouseEntered$.pipe(operators.takeUntil(this.destroy$)).subscribe(function (entered) {
                if (entered) {
                    _this.renderer.addClass(_this.elementRef.nativeElement, 'nz-resizable-handle-box-hover');
                }
                else {
                    _this.renderer.removeClass(_this.elementRef.nativeElement, 'nz-resizable-handle-box-hover');
                }
            });
        };
