(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/cdk/bidi'), require('@angular/forms'), require('rxjs'), require('rxjs/operators'), require('ng-zorro-antd/core/util'), require('@angular/cdk/a11y'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/radio', ['exports', '@angular/core', '@angular/cdk/bidi', '@angular/forms', 'rxjs', 'rxjs/operators', 'ng-zorro-antd/core/util', '@angular/cdk/a11y', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["ng-zorro-antd"] = global["ng-zorro-antd"] || {}, global["ng-zorro-antd"].radio = {}), global.ng.core, global.ng.cdk.bidi, global.ng.forms, global.rxjs, global.rxjs.operators, global["ng-zorro-antd"].core.util, global.ng.cdk.a11y, global.ng.common));
})(this, (function (exports, core, bidi, forms, rxjs, operators, util, a11y, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NzRadioComponent = /** @class */ (function () {
        ...
        NzRadioComponent.prototype.setupClickListener = function () {
            var _this = this;
            this.ngZone.runOutsideAngular(function () {
                rxjs.fromEvent(_this.elementRef.nativeElement, 'click')
                    .pipe(operators.takeUntil(_this.destroy$))
                    .subscribe(function (event) {
                    /** prevent label click triggered twice. **/
                    event.stopPropagation();
                    event.preventDefault();
                    if (_this.nzDisabled || _this.isChecked) {
                        return;
                    }
                    _this.ngZone.run(function () {
                        if (_this.nzRadioService) {
                            _this.nzRadioService.select(_this.nzValue);
                        }
                        if (_this.isNgModel) {
