(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var loaded$ = new rxjs.ReplaySubject(1);
    var loadingStatus = "unload" /* UNLOAD */;
    var NzCodeEditorService = /** @class */ (function () {
        ...
        NzCodeEditorService.prototype.requestToInit = function () {
            ...
            return loaded$.pipe(operators.tap(function () { return _this.onInit(); }), operators.map(function () { return _this.getLatestOption(); }));
        };
        NzCodeEditorService.prototype.loadMonacoScript = function () {
            ...
            var cleanup = function () {
                ...
                _this.document.documentElement.removeChild(loadScript);
            };
