(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/affix', ['exports', '@angular/cdk/bidi', '@angular/cdk/platform', '@angular/common', '@angular/core', 'rxjs', 'rxjs/operators', 'ng-zorro-antd/cdk/resize-observer', 'ng-zorro-antd/core/config', 'ng-zorro-antd/core/services', 'ng-zorro-antd/core/util'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["ng-zorro-antd"] = global["ng-zorro-antd"] || {}, global["ng-zorro-antd"].affix = {}), global.ng.cdk.bidi, global.ng.cdk.platform, global.ng.common, global.ng.core, global.rxjs, global.rxjs.operators, global["ng-zorro-antd"].cdk["resize-observer"], global["ng-zorro-antd"].core.config, global["ng-zorro-antd"].core.services, global["ng-zorro-antd"].core.util));
})(this, (function (exports, bidi, platform, common, core, rxjs, operators, resizeObserver, config, services, util) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NzAffixComponent = /** @class */ (function () {
        ...
        NzAffixComponent.prototype.registerListeners = function () {
            ...
            this.positionChangeSubscription = this.ngZone.runOutsideAngular(function () { return rxjs.merge.apply(void 0, __spreadArray(__spreadArray([], __read(Object.keys(AffixRespondEvents).map(function (evName) { return rxjs.fromEvent(_this.target, evName); }))), [_this.offsetChanged$.pipe(operators.map(function () { return ({}); })), _this.nzResizeObserver.observe(el)])).pipe(operators.throttleTime(NZ_AFFIX_DEFAULT_SCROLL_TIME, undefined, { trailing: true }), operators.takeUntil(_this.destroy$))
