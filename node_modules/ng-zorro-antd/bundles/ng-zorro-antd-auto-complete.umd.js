(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var NzAutocompleteOptionComponent = /** @class */ (function () {
      ...
      NzAutocompleteOptionComponent.prototype.ngOnInit = function () {
          var _this = this;
          this.ngZone.runOutsideAngular(function () {
              rxjs.fromEvent(_this.element.nativeElement, 'mouseenter')
                  .pipe(operators.filter(function () { return _this.mouseEntered.observers.length > 0; }), operators.takeUntil(_this.destroy$))
                  .subscribe(function () {
                  _this.ngZone.run(function () { return _this.mouseEntered.emit(_this); });
              });
              rxjs.fromEvent(_this.element.nativeElement, 'mousedown')
                  .pipe(operators.takeUntil(_this.destroy$))
                  .subscribe(function (event) { return event.preventDefault(); });
          });
      };
      NzAutocompleteOptionComponent.prototype.ngOnDestroy = function () {
          this.destroy$.next();
      };
