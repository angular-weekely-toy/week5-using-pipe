(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var NzSelectTopControlComponent = /** @class */ (function () {
        function NzSelectTopControlComponent(elementRef, ngZone, noAnimation) {
            this.elementRef = elementRef;
            this.ngZone = ngZone;
        ...
        NzSelectTopControlComponent.prototype.ngOnInit = function () {
            ...
            this.ngZone.runOutsideAngular(function () {
                rxjs.fromEvent(_this.elementRef.nativeElement, 'click')
                    ...
                    if (event.target !== _this.nzSelectSearchComponent.inputElement.nativeElement) {
                        _this.nzSelectSearchComponent.focus();
                    }
                });
                rxjs.fromEvent(_this.elementRef.nativeElement, 'keydown')
                    .pipe(operators.takeUntil(_this.destroy$))
                    .subscribe(function (event) {
                    if (event.target instanceof HTMLInputElement) {
                        ...
                        if (event.keyCode === keycodes.BACKSPACE &&
                            _this.mode !== 'default' &&
                            !inputValue &&
                            _this.listOfTopItem.length > 0) {
                            event.preventDefault();
                            // Run change detection only if the user has pressed the `Backspace` key and the following condition is met.
                            _this.ngZone.run(function () { return _this.onDeleteItem(_this.listOfTopItem[_this.listOfTopItem.length - 1]); });
                        }
                    }
                });
            });
    ...
    var NzSelectComponent = /** @class */ (function () {
        ...
        NzSelectComponent.prototype.updateCdkConnectedOverlayStatus = function () {
            ...
            if (this.platform.isBrowser && this.originElement.nativeElement) {
                var triggerWidth_1 = this.triggerWidth;
                polyfill.cancelRequestAnimationFrame(this.requestId);
                this.requestId = polyfill.reqAnimFrame(function () {
                    ...
                    if (triggerWidth_1 !== _this.triggerWidth) {
