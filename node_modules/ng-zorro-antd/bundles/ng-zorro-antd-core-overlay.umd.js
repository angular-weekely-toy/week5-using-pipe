(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/overlay'), require('@angular/core'), require('rxjs/operators'), require('ng-zorro-antd/core/services'), require('ng-zorro-antd/core/util')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/core/overlay', ['exports', '@angular/cdk/overlay', '@angular/core', 'rxjs/operators', 'ng-zorro-antd/core/services', 'ng-zorro-antd/core/util'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["ng-zorro-antd"] = global["ng-zorro-antd"] || {}, global["ng-zorro-antd"].core = global["ng-zorro-antd"].core || {}, global["ng-zorro-antd"].core.overlay = {}), global.ng.cdk.overlay, global.ng.core, global.rxjs.operators, global["ng-zorro-antd"].core.services, global["ng-zorro-antd"].core.util));
})(this, (function (exports, overlay, core, operators, services, util) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NzConnectedOverlayDirective = /** @class */ (function () {
        function NzConnectedOverlayDirective(cdkConnectedOverlay, nzDestroyService) {
            var _this = this;
            ...
            this.cdkConnectedOverlay.positionChange
                .pipe(operators.takeUntil(this.nzDestroyService))
                .subscribe(function (position) {
                if (_this.nzArrowPointAtCenter) {
                    _this.updateArrowPosition(position);
                }
            });
        }
        NzConnectedOverlayDirective.prototype.updateArrowPosition = function (position) {
            var originEl = this.cdkConnectedOverlay.origin.elementRef.nativeElement;
    ...
    NzConnectedOverlayDirective.propDecorators = {
        nzArrowPointAtCenter: [{ type: core.Input }]
    };
    __decorate([
        util.InputBoolean()
