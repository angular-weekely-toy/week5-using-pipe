(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var NzUploadBtnComponent = /** @class */ (function () {
        function NzUploadBtnComponent(ngZone, http, elementRef) {
            this.ngZone = ngZone;
            this.http = http;
        ...
        NzUploadBtnComponent.prototype.ngOnInit = function () {
            ...
            this.ngZone.runOutsideAngular(function () {
                rxjs.fromEvent(_this.elementRef.nativeElement, 'click')
                    ...
                    .subscribe(function () { return _this.onClick(); });
                rxjs.fromEvent(_this.elementRef.nativeElement, 'keydown')
                    ...
                    if (event.key === 'Enter' || event.keyCode === keycodes.ENTER) {
                        _this.onClick();
                    }
                });
            });
    ...
    var NzUploadListComponent = /** @class */ (function () {
        ...
        NzUploadListComponent.prototype.previewImage = function (file) {
            ...
            img.src = objectUrl;
            return rxjs.fromEvent(img, 'load').pipe(operators.map(function () {
        ...
        NzUploadListComponent.prototype.genThumb = function () {
            ...
            this.list
                ...
                var dataUrl$ = (_this.previewFile ? _this.previewFile(file) : _this.previewImage(file.originFileObj)).pipe(operators.takeUntil(_this.destroy$));
                _this.ngZone.runOutsideAngular(function () {
                    dataUrl$.subscribe(function (dataUrl) {
        ...
        NzUploadListComponent.prototype.ngOnDestroy = function () {
            this.destroy$.next();
        };
